...
function invokeSpell(input) {
    ...
    if (masukq == 3 && masukw == 0 && masuke == 0) {
        return spells[0].spellName;
    }
    else if (masukq == 0 && masukw == 2 && masuke == 1) {
        return spells[1].spellName;
    }
    else if (masukq == 1 && masukw == 0 && masuke == 2) {
        return spells[2].spellName;
    }
    else if (masukq == 0 && masukw == 0 && masuke == 3) {
        return spells[3].spellName;
    }
    else if (masukq == 1 && masukw == 2 && masuke == 0) {
        return spells[4].spellName;
    }
    else if (masukq == 0 && masukw == 3 && masuke == 0) {
        return spells[5].spellName;
    }
    else if (masukq == 0 && masukw == 1 && masuke == 2) {
        return spells[6].spellName;
    }
    else if (masukq == 1 && masukw == 1 && masuke == 1) {
        return spells[7].spellName;
    }
    else if (masukq == 2 && masukw == 0 && masuke == 1) {
        return spells[8].spellName;
    }
    else if (masukq == 2 && masukw == 1 && masuke == 0) {
...
console.log(invokeSpell('wqa')); // not exist
